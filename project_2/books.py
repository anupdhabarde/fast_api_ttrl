...
class BookRequest(BaseModel):
    id: int | None = Field(title="id is not required")
...
BOOKS = [
    Book(1, "Computer Science Pro", "codingwithanup", "A very nice book!", 5, 1970),
    Book(2, "Be Fast with FastAPI", "codingwithanup", "A great book!", 5, 1980),
    Book(3, "Master Endpoints", "codingwithanup", "An awesome book!", 5, 1990),
